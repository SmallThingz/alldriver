...
pub const NetworkRecord = types.NetworkRecord;
pub const NetworkStatusTimelinePoint = types.NetworkStatusTimelinePoint;
pub const RedirectHop = types.RedirectHop;
pub const FrameInfo = types.FrameInfo;
pub const ServiceWorkerInfo = types.ServiceWorkerInfo;
pub const SnapshotPhase = types.SnapshotPhase;
pub const SnapshotBundle = types.SnapshotBundle;
...
pub const NavigationCause = types.NavigationCause;
pub const CookieChangeKind = types.CookieChangeKind;
pub const CookieChangeSource = types.CookieChangeSource;
